...
./bin/protoc --plugin=protoc-gen-grpc-web=${PROJECT_PATH}/bin/protoc-gen-grpc-web --grpc-web_out=import_style=commonjs+dts,mode=grpcwebtext:${PROTO_DEST} -I ${PROJECT_PATH}/proto ${PROJECT_PATH}/proto/*.proto
